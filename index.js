...
//   req.next()
// })
var sendTalk = function (prompt) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, response.data.choices[0].message];
        }
    });
}); };
app.listen(9085, function () { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sendTalk("hello")];
            case 1:
                result = _a.sent();
                console.log(result);
